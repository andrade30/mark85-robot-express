...
Deve poder cadastrar um novo usuário
    ...
    # Fill Text    css=#name        Alessandro Andrade
    # Fill Text    css=#email       andrade@hotmail.com 
...
Não deve cadastrar usuário com email incorreto 
    [Tags]    inv_email
