...
client = MongoClient('mongodb+srv://qa:xperience@cluster0.egbpqvp.mongodb.net/?retryWrites=true&w=majority')
...
def insert_user(user):
    ...
    users = db['users'] #acesso a collection users
    users.insert_one(doc) #insere um registro na collection
    print(user)